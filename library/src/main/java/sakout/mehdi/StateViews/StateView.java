...
public class StateView extends ViewFlipper {
    ...
    private void setIcon(View view, Drawable icon, Integer color, int iconSize) {
        ...
        if (color != null) {
            mImageView.setColorFilter(color, PorterDuff.Mode.SRC_IN);
        } else {
            TypedValue typedValue = new TypedValue();
            //getContext().getTheme().resolveAttribute(R.attr.white, typedValue, true);
            mImageView.setColorFilter(typedValue.data, PorterDuff.Mode.SRC_IN);
        }
